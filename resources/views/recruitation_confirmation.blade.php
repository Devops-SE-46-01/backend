...
<div style="
    ...
    <h3 style="
            font-size: 4vh;
        ">Halo, {{ $recruitation->name }} 👋</h3>
    <p>
        Terima kasih telah mendaftar pada rekruitasi yang diadakan oleh Mobile Innovation Laboratory.
        Silahkan menunggu informasi selanjutnya pada media sosial motion laboratory, semangat 🔥
    </p>
</div>
